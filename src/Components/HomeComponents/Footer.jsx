...
const socialLinks = [
  // {
  //   icon: FaFacebookF,
  //   url: "#", // Add Facebook link if available
  // },
  {
    icon: FaInstagram,
    url: "https://www.instagram.com/zcoin_official/?hl=en",
  },
  {
    icon: IoLogoTwitter,
    url: "https://x.com/Zcoin__Official",
  },
  // {
  //   icon: IoLogoLinkedin,
  //   url: "#", // Add LinkedIn link if available
  // },
  {
    icon: FaTelegramPlane,
    url: "https://t.me/zcoin_dev",
  },
];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Empowering The Future Of Cryptocurrency through Innovative Solutions.
            </p>
          ...
          {/* Newsletter */}
          <div className="space-y-4">
            <h3 className="text-blue-400 text-base font-semibold">Contact Us</h3>
            <a href="mailto:contact@zcoin.dev" className="text-gray-400 text-sm">
              Email: contact@zcoin.dev
            </a>
...
<<<<<<< Updated upstream
              © 2025 XPFI-Coin. All rights reserved.
=======
              © 2025 XPFI Token. All rights reserved.
>>>>>>> Stashed changes
            </p>
